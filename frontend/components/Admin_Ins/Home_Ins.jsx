...
function CHome() {
  ...
  return (
    ...
    <div className="sun-container">
      {/* Add a button to navigate to CCreate */}
      <Link to="/CCreate">
        <button className="sun-add-btn">
          Add Institute
        </button>
      </Link>
        {/* Search bar */}
        ...
        <div className="sun-records">
          ...
          {filteredInstitutes.map((institute) => (
            <div key={institute.instituteId} className="sun-record">
              ...
              <div>
  <img src={institute.image} alt="Institute" className="sun-image" style={{ width: '400px' }} />
</div>
                <div><strong>Course Name:</strong> {institute.instituteName}</div>
